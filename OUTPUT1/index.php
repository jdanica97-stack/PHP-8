    ...
    <fieldset style="margin-top: 20px">
        ...
        <table>
            ...
            <tr>
                <td>Gender</td>
                <td>
                    <input type="text" name="gender" placeholder="Enter First Name" required />
                </td>
            </tr>
            <tr>
                <td>Email</td>
                <td>
                    <input type="email" name="email" placeholder="Enter First Name" required />
                </td>
            </tr>
            <tr>
                <td>Address</td>
                <td>
                    <input type="text" name="address" placeholder="Enter First Name" required />
                </td>
            </tr>
            <tr>
